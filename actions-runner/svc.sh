...
SVC_NAME="actions.runner.Schwifty101-finalprojectSCD.Sobans-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Schwifty101-finalprojectSCD.Sobans-MacBook-Pro)"
